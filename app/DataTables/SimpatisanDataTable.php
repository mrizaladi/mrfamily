        ...
        return (new EloquentDataTable($query))
            ->editColumn('status', function ($row) {
                ...
                if (in_array(strtolower($fileExtension), $allowedEx) || $row->status == true){
                    ...
                    $temp = '<a readonly class="disable badge bg-warning text-nowrap" disabled><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock" viewBox="0 0 16 16">
